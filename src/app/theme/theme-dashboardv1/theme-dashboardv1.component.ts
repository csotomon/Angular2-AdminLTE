...
@Component({
  selector: 'app-theme-dashboardv1',
  templateUrl: './theme-dashboardv1.component.html',
  styleUrls: ['./theme-dashboardv1.component.css']
})
export class ThemeDashboardv1Component implements OnInit {
  ...
  ngOnInit() {
    ...
    AdminLTE.loadWysihtml5('.textarea');
    ...
    AdminLTE.loadVectorMap('#world-map', {
      map: 'world_mill_en',
    ...
    AdminLTE.loadSparkline('#sparkline-1', myvalues, {
      type: 'line',
      lineColor: '#92c1dc',
      fillColor: '#ebf4f9',
      height: '50',
    ...
    AdminLTE.loadSparkline('#sparkline-2', myvalues, {
      type: 'line',
      lineColor: '#92c1dc',
      fillColor: '#ebf4f9',
      height: '50',
    ...
    AdminLTE.loadSparkline('#sparkline-3', myvalues, {
      type: 'line',
      lineColor: '#92c1dc',
      fillColor: '#ebf4f9',
      height: '50',
